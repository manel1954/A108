...
cd /home/pi/Desktop
sudo cp Abrir_MMDVMPLUS.desktop /home/pi
sudo sed -i "4c Exec=sh -c 'cd /home/pi/$SCRIPTS_version;lxterminal --geometry=88x19 --title=DMR+ -e sudo sh ejecutar_dmrplus_new.sh'" /home/pi/Abrir_MMDVMPLUS.desktop
