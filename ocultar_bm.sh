...
sed -i "10c Name[es_ES]=." /home/pi/Editar_MMDVMBM.desktop
...
sed -i "5c Icon=/home/pi/$SCRIPTS_version/ICONO_TRANSPARENTE.png" /home/pi/RXF_BM.desktop
sed -i "10c Name[es_ES]=." /home/pi/RXF_BM.desktop
